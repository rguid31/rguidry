document.addEventListener("DOMContentLoaded", () => {
    ...
    const resources = [
      ...
      {
        id: 9,
        title: "Apps & Ebooks Collection",
        icon: "Smartphone",
        description: "Curated mobile apps and digital reading resources",
        content: [
          "Mutaz.net - Premium apps and ebooks collection",
          "Productivity and utility applications",
          "Educational and learning apps",
          "Digital reading platforms and ebooks",
          "App recommendations and reviews",
        ],
        color: "color-indigo",
        iconColor: "icon-color-indigo",
        path: "apps-ebooks-collection.html",
      },
      {
        id: 10,
